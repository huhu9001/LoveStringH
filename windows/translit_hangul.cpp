...
constexpr static TDict<std::string_view, int>::Dict dict_initial({
	{"g", 0},
	{"kk", 1},
	{"n", 2},
	{"d", 3},
...
constexpr static TDict<std::string_view, int>::Dict dict_median({
	{"a", 0},
	{"ae", 1},
	{"ya", 2},
	{"yae", 3},
...
constexpr static TDict<std::string_view, int>::Dict dict_coda({
	{"", 0},
	{"k", 1}, {"g", 1},
	{"kk", 2},
	{"ks", 3},
...
static const TDict<std::string_view, int>::Dict dict_initial_archaic({
	{"K", 0x1100},
	{"G", 0x1101},
	{"N", 0x1102},
	{"T", 0x1103},
...
static const TDict<std::string_view, int>::Dict dict_median_archaic({
	{"A", 0x1161},
	{"AI", 0x1162},
	{"YA", 0x1163},
	{"YAI", 0x1164},
...
static const TDict<std::string_view, int>::Dict dict_coda_archaic({
	{ "", 0 },
	{"K", 0x11a8},
	{"G", 0x11a9},
	{"KS", 0x11aa},
